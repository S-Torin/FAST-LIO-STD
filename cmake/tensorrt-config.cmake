...
set(TrnsorRT_DIR ~/TensorRT-8.6.1.6)
set(CMAKE_LIBRARY_PATH ${TrnsorRT_DIR}/lib)
...
if(CUDA_FOUND AND NVINFER AND NVINFERPLUGIN AND NVPARSERS AND NVONNXPARSER)
  ...
  list(APPEND TENSORRT_LIBRARIES ${CUDA_LIBRARIES} ${NVINFER} ${NVINFERPLUGIN} ${NVPARSERS} ${NVONNXPARSER})
  message("All togheter now (libs): ${TENSORRT_LIBRARIES}")
  list(APPEND TENSORRT_INCLUDE_DIRS ${CUDA_INCLUDE_DIRS} ${TrnsorRT_DIR}/include)
